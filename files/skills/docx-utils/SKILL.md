...
1. Rode `D:\codex-setup\files\scripts\install-docx-utils-global.ps1` para copiar a fonte para `~/.codex/skills/docx-utils` e instalar/restaurar o destino global.
...
- `D:\codex-setup\files\scripts\install-docx-utils-global.ps1`: copia a skill para `~/.codex/skills/docx-utils` e executa a instalação no destino.
